...
static_system_prompt = "    For the user query, and user instructions, the follwing response was generated by the LLM.\
                            Upon evaluation, it was found out that either the hallucination score exceeded the threshold value OR instructions defined by the user were not followed.\
